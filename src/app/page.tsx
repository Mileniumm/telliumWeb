...
export default function ChamomileTea() {
  return (
      <main className=" relative flex bg-neutral-100 w-full h-screen justify-center items-center star h-full p-4 md:items-start md:justify-start">
      ...
      <div className="flex justify-center h-screen flex-col">
          ...
          <h2 className="text-7xl font-serif text-neutral-950 mb-4 font-bold w-16 md:text-9xl">CHAMOMILE TEA</h2>
          ...
          <div className="absolute flex flex-col w-2/3 h-full">
              <Image className={"flex flex-col relative w-full h-full object-scale-down opacity-25"} width={1200} height={800} alt={"imagen de planta de té"} src={"https://res.cloudinary.com/dioizs3xa/image/upload/v1746750092/Ibiscus_tvbr0f.png"}/>
          </div>
      </main>
  );
}
